...
namespace TestLauncher
{
    public class Example
    {
        ...
        {
            var prKeyPath = ".\\files_for_test\\private_key_test.xml";
            var certPath = ".\\files_for_test\\client.pfx";
            var certPass = "1234";
            ...
            var checkAccess = await dummyOrangeRequest.GetAccessStateAsync(new ReqAccessStatus { INN = "7725327863", Group = "Main_2", Key = "7725327863" });
            ...
            var res2 = await dummyOrangeRequest.GetCheckStateAsync("7725327863", "11223344");
            ...
            var res4 = await dummyOrangeRequest.GetCorrectionCheckStateAsync("7725327863", "1122334414");
            ...
            Console.WriteLine("GetCheckStateAsync...");
            var res6 = await dummyOrangeRequest.GetCheckStateAsync("7725327863", "1122334412");
            ...
            var res8 = await dummyOrangeRequest.GetCorrectionCheckStateAsync12("7725327863", "11223344121");
